...
/*   Updated: 2023/12/08 17:04:47 by hnogared         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_object	*new_light(t_object *to_set, t_coords coords, float brightness)
{
	...
	to_set->special_data.light.diameter = RT_DEFAULT_LIGHT_DIAM;
	to_set->special_data.light.radius = (float) RT_DEFAULT_LIGHT_DIAM / 2;
	to_set->ft_get_color = &get_uncolored_color;
